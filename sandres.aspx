...
<html lang="es" class"no-js">
    ...
    <body>  
        <Div id="contenidos">
            <header>
                <div id="apDiv1"><img src="img/ghls.jpg" width="1000" height="168">
                  <div id="apDiv24">Hoteles en San Andres</div>
              </div>
            </header>
          <p>&nbsp;</p>
        <p>&nbsp;</p>
...
<!-- ESTA PAGINA ES DE LECTURAS, LO DICE ABAJO  -->
   ...
   <article>
                   <figure>
                        <img src="img/sanandres.jpg" alt="Diseno">
                    </figure>
    ...
    <aside> 
                ...
                <iframe src='js/slider.html' width='260' height='180' frameborder='0'></iframe>    
              	...
              	<div id="apDiv7">
                <div id="apDiv12">Hoteles San Andres</div>
      			</div>
      			<div id="apDiv8"><iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d62314.07180713485!2d-81.74399495958363!3d12.540686731644788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1shoteles+san+andres!5e0!3m2!1ses!2ses!4v1481390633094" width="260" height="180" frameborder="0" style="border:0" allowfullscreen></iframe></div>
              <div id="apDiv15"></div>
