...
<html lang="es" class"no-js">
    ...
    <body>  
        <Div id="contenidos">
            <header>
                <div id="apDiv1"><img src="img/SantaBarb.jpg" width="1000" height="168">
                  <div id="apDiv24">Hoteles en el Eje Cafetero</div>
              </div>
            </header>
          <p>&nbsp;</p>
        <p>&nbsp;</p>
...
<article>
                   <figure>
                        <img src="img/ejecafe.jpg" alt="Diseno">
                    </figure>
                    </article>
    ...
    <aside> 
                ...
                <iframe src='js/slider.html' width='260' height='180' frameborder='0'></iframe>    
              	...
              	<div id="apDiv7">
                <div id="apDiv12">Hoteles Eje Cafetero</div>
      			</div>
      			<div id="apDiv8"><iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d127266.38144997816!2d-75.74788177293573!3d4.580658491946839!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1shoteles+eje+cafetero!5e0!3m2!1ses!2ses!4v1481390137452" width="260" height="180" frameborder="0" style="border:0" allowfullscreen></iframe></div>
              <div id="apDiv15"></div>
