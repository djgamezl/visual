...
<html lang="es" class"no-js">
    ...
    <body>  
        <Div id="contenidos">
            <header>
                <div id="apDiv1"><img src="img/dubai.jpg" width="1000" height="168">
                  <div id="apDiv24">Hoteles en el Mundo</div>
              </div>
            </header>
          <p>&nbsp;</p>
        <p>&nbsp;</p>
                 ...
                 <li><a href="ejecafe.aspx" class="menu">Eje cafetero</a></li>
                  <li><a href="bogota.aspx" class="menu">Bogotá</a></li>
                   <li><a href="sandres.aspx" class="menu">San Andres</a></li>
                    <li><a href="sandres.aspx" class="menu">Hoteles en el mundo</a></li>               
                <div id="apDiv19">
              </ul>
                 <div id="apDiv3">    
...
<!-- ESTA PAGINA ES DE LECTURAS, LO DICE ABAJO  -->
   ...
   <article>
                   <figure>
                        <img src="img/dubai2.jpg" alt="Diseno">
                    </figure>
    ...
    <aside> 
                ...
                <iframe src='js/slider.html' width='260' height='180' frameborder='0'></iframe>    
              	...
              	<div id="apDiv7">
                <div id="apDiv12">Hoteles Dubai</div>
      			</div>
      			<div id="apDiv8"><iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d326815.70326661994!2d55.008712151271816!3d25.17496424330902!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1shoteles+dubai!5e0!3m2!1ses!2ses!4v1481390462336" width="260" height="180" frameborder="0" style="border:0" allowfullscreen></iframe></div>
              <div id="apDiv15"></div>
              <div id="apDiv16">Mejores Hoteles</div>
      <div id="apDiv18"><iframe width="260" height="180" src="https://www.youtube.com/embed/ybBiHgt2ZCE" frameborder="0" allowfullscreen></iframe></div>
		...
		<Footer>
          ...
          <div id="apDiv26">Elaborado por: grupo #301122_75, estudiantes del programa DISEÑOS DE SITIOS WEB</div>
