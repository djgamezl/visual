...
<html lang="es" class"no-js">
    ...
    <body>  
        <Div id="contenidos">
            <header>
                <div id="apDiv1"><img src="img/zuana-1.jpg" width="1000" height="168">
                  <div id="apDiv24">Hoteles en el caribe Colombiano</div>
              </div>
            </header>
          <p>&nbsp;</p>
        <p>&nbsp;</p>
...
<!-- ESTA ES LA PAGINA PRINCIPAL, LO DICE ABAJO  -->
  ...
  <article>
                   <figure>
                        <img src="img/caribe.jpg" alt="Diseno">
                    </figure>
    ...
    <aside> 
                ...
                <div id="apDiv7">
                <div id="apDiv12">Hoteles en el caribe</div>
            </div>
            <div id="apDiv8"><iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d2386439.011391531!2d-76.45332254325172!3d10.77836379933197!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1shoteles+en+el+caribe!5e0!3m2!1ses!2ses!4v1481390075294" width="260" height="180" frameborder="0" style="border:0" allowfullscreen></iframe></div>
              <div id="apDiv15"></div>
